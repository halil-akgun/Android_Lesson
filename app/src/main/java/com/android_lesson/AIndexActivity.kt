...
//        }
        ...
        viewBinding.mainGoToZ1.setOnClickListener {
            val intent = Intent(this@AIndexActivity, Z1Activity::class.java)
            startActivity(intent)
        }

        viewBinding.mainGoToZ2.setOnClickListener {
            val intent = Intent(this@AIndexActivity, Z2Activity::class.java)
            startActivity(intent)
        }

        viewBinding.mainGoToZ3.setOnClickListener {
            val intent = Intent(this@AIndexActivity, Z3Activity::class.java)
            startActivity(intent)
        }

        viewBinding.mainGoToZ4.setOnClickListener {
